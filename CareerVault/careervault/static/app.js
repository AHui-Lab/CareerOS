...
window.addEventListener('message',event=>{if(event.data?.type==='careeros-vault-view'&&['dashboard','experiences','profile','settings'].includes(event.data.view))showView(event.data.view)});
